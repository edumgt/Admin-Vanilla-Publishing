...
function initializeGrid(data) {
    const columns = [
        { header: "읍면동 이름", name: "읍면동" },
        { header: "우편번호", name: "우편번호", editor: 'text' },
        { header: "위도", name: "위도", editor: 'text' },
        { header: "경도", name: "경도", editor: 'text' },
        { header: "약국수", name: "약국수", editor: 'text' },
        { header: "병의원수", name: "병의원수", editor: 'text' },
        { header: "학교수", name: "학교수", editor: 'text' },
        { header: "주차장수", name: "주차장수", editor: 'text' },
        { header: "주민수", name: "주민수", editor: 'text' },
        { header: "상점수", name: "상점수", editor: 'text' },
        { header: "공원수", name: "공원수", editor: 'text' },
        { header: "도서관수", name: "도서관수", editor: 'text' },
        { header: "버스정류장수", name: "버스정류장수", editor: 'text' },
        { header: "지하철역수", name: "지하철역수", editor: 'text' },
        { header: "음식점수", name: "음식점수", editor: 'text' },
        { header: "체육시설수", name: "체육시설수", editor: 'text' },
        { header: "문화시설수", name: "문화시설수", editor: 'text' },
        { header: "관광명소수", name: "관광명소수", editor: 'text' },
        { header: "주택수", name: "주택수", editor: 'text' },
        ...
        if (selectedRows.length == 2) {
            ...
            detailContentRight.innerHTML = `
                <div>
                    ...
                    <p>위도: ${selectedRows[1].위도}</p>
                    <p>경도: ${selectedRows[1].경도}</p>
                    <p>약국수: ${selectedRows[1].약국수}</p>
                    <p>병의원수: ${selectedRows[1].병의원수}</p>
                    <p>학교수: ${selectedRows[1].학교수}</p>
                    <p>주차장수: ${selectedRows[1].주차장수}</p>
                    <p>주민수: ${selectedRows[1].주민수}</p>
                    <p>상점수: ${selectedRows[1].상점수}</p>
                    <p>공원수: ${selectedRows[1].공원수}</p>
                    <p>도서관수: ${selectedRows[1].도서관수}</p>
                    <p>버스정류장수: ${selectedRows[1].버스정류장수}</p>
                    <p>지하철역수: ${selectedRows[1].지하철역수}</p>
                    <p>음식점수: ${selectedRows[1].음식점수}</p>
                    <p>체육시설수: ${selectedRows[1].체육시설수}</p>
                    <p>문화시설수: ${selectedRows[1].문화시설수}</p>
                    <p>관광명소수: ${selectedRows[1].관광명소수}</p>
                    <p>주택수: ${selectedRows[1].주택수}</p>
